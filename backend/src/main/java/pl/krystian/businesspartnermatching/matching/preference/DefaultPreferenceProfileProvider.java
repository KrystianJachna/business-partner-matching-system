...
@Component
public class DefaultPreferenceProfileProvider
        implements PreferenceProfileProvider {

    private static final PreferenceProfile NEED_PROFILE =
    ...
    private static final PreferenceProfile OFFER_PROFILE =
            new PreferenceProfile(
                    Map.of(
                            MatchingCriterion.SPECIALIZATION,
                            new BigDecimal("0.35"),
    ...
    @Override
    public PreferenceProfile forNeed(BusinessNeed need) {
    ...
    @Override
    public PreferenceProfile forOffer(BusinessOffer offer) {
        Objects.requireNonNull(
                offer,
